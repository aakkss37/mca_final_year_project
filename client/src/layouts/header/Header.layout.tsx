...
import logoSVG from '@/assets/photos/logo.png';
        ...
        <header className="relative w-full">
            ...
            >
                ...
                <nav className="pc-sm:hidden">
                    <ul className="flex flex-row gap-20 px-20 py-3 text-xl">
                        <li>
                            <Link
                                to="/"
                                className={`hover:text-primary-500 ${activeTab === '/' ? 'text-primary-500' : ''}`}
                            >
                                Home
                            </Link>
                        </li>
                        <li>
                            <Link
                                to="/products"
                                className={`hover:text-primary-500 ${activeTab === '/products' ? 'text-primary-500' : ''}`}
                            >
                                Products
                            </Link>
                        </li>
                        <li>
                            <Link
                                to="/cart"
                                className={`hover:text-primary-500 ${activeTab === '/cart' ? 'text-primary-500' : ''}`}
                            >
                                Cart
                            </Link>
                        </li>
